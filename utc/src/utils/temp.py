...
if __name__ == '__main__':
    ...
    graph.road_network.name = "Luxembourg"
    regions: List[Graph] = [Graph(RoadNetwork()) for _ in range(3)]
    for index, region in enumerate(["lust_orange", "lust_lime", "lust_red"]):
    ...
    data: List[str] = [
        DirPaths.SCENARIO_STATISTICS.format("lust_25200_32400_planned_mip") + "/stats_edgedata.out.xml",
        DirPaths.SCENARIO_STATISTICS.format("lust_25200_32400") + "/stats_edgedata.out.xml"
    ]
